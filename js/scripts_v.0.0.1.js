...
function mtn_submit_chk(){
  ...
  if(
    ...
    ((conai_chk == 1 && conai_val >=100000) || conai_chk == 0) && //conai>=100000
...
function get_csl_val(sel){
  ...
  if (selidx > 0) {
    ...
    document.getElementById('csl_comp').disabled = false;
