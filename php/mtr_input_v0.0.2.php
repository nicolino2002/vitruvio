...
<html>
   <head>
      ...
      <table width="100%" style="border-collapse: collapse;">
         ...
         <tbody>
           <tr>
             ...
             <td>
               <input type="number" min="100000" class="campo" id="canone" name = "canone" onchange="calcola_iva(this, 0.1);mtr_submit_chk();" placeholder="0" required autofocus value="<?php echo $mtr_canone; ?>"></input>
             </td>
             ...
             <td>
               <input type="number" step="0.01"  min="10000" class="campo" id="canone_iva" name = "canone_iva" onchange=";mtr_submit_chk();" placeholder="0" required autofocus value="<?php echo $mtr_canone_iva; ?>"></input>
             </td>
           ...
           <tr>
             ...
             <td>
                <select class="select" style="padding:2px 2px; height:30px; width:100px; v-align:middle;" id="cts_chk" name="cts_chk" onchange="mtr_submit_chk();" required autofocus>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="cts" name = "cts" onchange="calcola_iva(this, 0.1);mtr_submit_chk();" placeholder="0" required autofocus value="<?php echo $mtr_cts; ?>"></input>
             </td>
             <td style="text-align:center">
                <select class="select" style="padding:2px 2px; height:30px; width:200px; v-align:middle;" id="cts_ben" name="cts_ben" onchange="mtr_submit_chk();" required autofocus>
             ...
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="cts_iva" name = "cts_iva" onchange=";mtr_submit_chk();" placeholder="0" required autofocus value="<?php echo $mtr_cts_iva; ?>"></input>
             </td>
           ...
           <tr>
             ...
             <td>
                <select class="select" style="padding:2px 2px; height:30px; width:100px; v-align:middle;" id="ctr_chk" name="ctr_chk" onchange="mtr_submit_chk();" required autofocus>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="ctr" name = "ctr" onchange="calcola_iva(this, 0.1);mtr_submit_chk();" placeholder="0" required autofocus value="<?php echo $mtr_ctr; ?>"></input>
             </td>
             <td style="text-align:center">
                <select class="select" style="padding:2px 2px; height:30px; width:200px; v-align:middle;" id="ctr_ben" name="ctr_ben" onchange="mtr_submit_chk();" required autofocus>
             ...
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="ctr_iva" name = "ctr_iva" onchange=";mtr_submit_chk();" placeholder="0" required autofocus value="<?php echo $mtr_ctr_iva; ?>"></input>
             </td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="cov" name = "cov" placeholder="0" value="<?php echo $mtr_cov; ?>"></input>
             </td>
             <td></td>
             <td></td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="cos" name = "cos" placeholder="0" value="<?php echo $mtr_cos; ?>"></input>
             </td>
             <td></td>
             <td></td>
             <td>Come da determina ARERA n. XXXXX.</td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="rcnd" name = "rcnd" placeholder="0" value="<?php echo $mtr_rcnd; ?>"></input>
             </td>
             <td></td>
             <td></td>
             <td>Come da determina ARERA n. XXXXX.</td>
           ...
           <tr style="border-bottom: 1px solid black;">
             ...
             <td>
                <select class="select" style="padding:2px 2px; height:30px; width:100px; v-align:middle;" id="csl_chk" name="csl_chk" onchange="mtr_submit_chk();" required autofocus>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="csl" name = "csl" onchange="calcola_iva(this, 0.1);mtr_submit_chk();" placeholder="0" required autofocus value="<?php echo $mtr_csl; ?>"></input>
             </td>
             <td style="text-align:center">
                <select class="select" style="padding:2px 2px; height:30px; width:100px; v-align:middle;" id="csl_ben" name="csl_ben" onchange="mtr_submit_chk();" required autofocus>
                ...
                <select class="select" style="padding:2px 2px; height:30px; width:100px; v-align:middle;" id="csl_comp" name="csl_comp" required autofocus>
                  <option value="0" <?php if ($mtr_csl_comp==0){echo 'selected';} ?>>No</option>
                  <option value="1" <?php if ($mtr_csl_comp==1){echo 'selected';} ?>>Si</option>
                </select>
             </td>
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="csl_iva" name = "csl_iva" onchange=";mtr_submit_chk();" placeholder="0" required autofocus value="<?php echo $mtr_csl_iva; ?>"></input>
             </td>
             <td>Inserire il valore dell'imponibile e dell'IVA  presenti a bilancio del comune dell'anno <?php echo $year ?>.</td>
             <td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="carc_pers" name = "carc_pers" onchange="calc_carc_tot();" placeholder="0" value="<?php echo $mtr_carc_pers; ?>"></input>
             </td>
             <td></td>
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="carc_pers_iva" name = "carc_pers_iva" onchange="calc_carc_iva();" placeholder="0" value="<?php echo $mtr_carc_pers_iva; ?>"></input>
             </td>
             <td>Inserire il valore dell'imponibile e dell'IVA  presenti a bilancio del comune dell'anno <?php echo $year ?>.</td>
             <td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="carc_post" name = "carc_post" onchange="calc_carc_tot();" placeholder="0" value="<?php echo $mtr_carc_post; ?>"></input>
             </td>
             <td></td>
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="carc_post_iva" name = "carc_post_iva" onchange="calc_carc_iva();" placeholder="0" value="<?php echo $mtr_carc_post_iva; ?>"></input>
             </td>
             <td>Inserire il valore dell'imponibile e dell'IVA  presenti a bilancio del comune dell'anno <?php echo $year ?>.</td>
             <td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="carc_risc" name = "carc_risc" onchange="calcola_iva(this, 0.22);calc_carc_tot();" placeholder="0" value="<?php echo $mtr_carc_risc; ?>"></input>
             </td>
             <td></td>
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="carc_risc_iva" name = "carc_risc_iva" onchange="calc_carc_iva();" placeholder="0" value="<?php echo $mtr_carc_risc_iva; ?>"></input>
             </td>
             <td>Inserire il valore dell'imponibile e dell'IVA  presenti a bilancio del comune dell'anno <?php echo $year ?>.</td>
             <td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="carc_cont" name = "carc_cont" onchange="calcola_iva(this, 0.22);calc_carc_tot();" placeholder="0" value="<?php echo $mtr_carc_cont; ?>"></input>
             </td>
             <td></td>
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="carc_cont_iva" name = "carc_cont_iva" onchange="calc_carc_iva();" placeholder="0" value="<?php echo $mtr_carc_cont_iva; ?>"></input>
             </td>
             <td>Inserire il valore dell'imponibile e dell'IVA  presenti a bilancio del comune dell'anno <?php echo $year ?>.</td>
             <td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="carc_soft" name = "carc_soft" onchange="calcola_iva(this, 0.22);calc_carc_tot();" placeholder="0" value="<?php echo $mtr_carc_soft; ?>"></input>
             </td>
             <td></td>
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="carc_soft_iva" name = "carc_soft_iva" onchange="calc_carc_iva();" placeholder="0" value="<?php echo $mtr_carc_soft_iva; ?>"></input>
             </td>
             <td>Inserire il valore dell'imponibile e dell'IVA  presenti a bilancio del comune dell'anno <?php echo $year ?>.</td>
             <td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="carc_gest" name = "carc_gest" onchange="calcola_iva(this, 0.22);calc_carc_tot();" placeholder="0" value="<?php echo $mtr_carc_gest; ?>"></input>
             </td>
             <td></td>
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="carc_gest_iva" name = "carc_gest_iva" onchange="calc_carc_iva();" placeholder="0" value="<?php echo $mtr_carc_gest_iva; ?>"></input>
             </td>
             <td>Inserire il valore dell'imponibile e dell'IVA  presenti a bilancio del comune dell'anno <?php echo $year ?>.</td>
             <td>
           ...
           <tr style="border-bottom: 1px solid black;">
             ...
             <td>
               <input type="number" min="0" class="campo" id="carc_tot" name = "carc_tot" placeholder="0" value="0" disabled></input>
             </td>
             <td></td>
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="carc_tot_iva" name = "carc_tot_iva" placeholder="0" value="0" disabled></input>
             </td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="cc_cgg" name = "cc_cgg" onchange="calcola_iva(this, 0.22);calc_cc_tot();" placeholder="0" value="<?php echo $mtr_cc_cgg; ?>"></input>
             </td>
             <td></td>
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="cc_cgg_iva" name = "cc_cgg_iva" onchange="calc_cc_iva();" placeholder="0" value="<?php echo $mtr_cc_cgg_iva; ?>"></input>
             </td>
             <td>Inserire il valore dell'imponibile e dell'IVA  presenti a bilancio del comune dell'anno <?php echo $year ?>.</td>
             <td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="cc_ccd" name = "cc_ccd" onchange="calcola_iva(this, 0.22);calc_cc_tot();" placeholder="0" value="<?php echo $mtr_cc_ccd; ?>"></input>
             </td>
             <td></td>
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="cc_ccd_iva" name = "cc_ccd_iva" onchange="calc_cc_iva();" placeholder="0" value="<?php echo $mtr_cc_ccd_iva; ?>"></input>
             </td>
             <td>Inserire il valore dell'imponibile e dell'IVA presenti a bilancio del comune dell'anno <?php echo $year ?>.</td>
             <td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="cc_coal" name = "cc_coal" onchange="calc_cc_tot();" placeholder="0" value="<?php echo $mtr_cc_coal; ?>"></input>
             </td>
             <td></td>
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="cc_coal_iva" name = "cc_coal_iva" onchange="calc_cc_iva();" placeholder="0" value="<?php echo $mtr_cc_coal_iva; ?>"></input>
             </td>
             <td>Inserire il valore dell'imponibile e dell'IVA  presenti a bilancio del comune dell'anno <?php echo $year ?>.</td>
             <td>
           ...
           <tr style="border-bottom: 1px solid black;">
             ...
             <td>
               <input type="number" min="0" class="campo" id="cc_tot" name = "cc_tot" placeholder="0" value="0" disabled></input>
             </td>
             <td></td>
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="cc_tot_iva" name = "cc_tot_iva" placeholder="0" value="0" disabled></input>
             </td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="acc_disc" name = "acc_disc" onchange="calc_acc_tot();" placeholder="0" value="<?php echo $mtr_acc_disc; ?>"></input>
             </td>
             <td></td>
             <td></td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="acc_cde" name = "acc_cde" onchange="calc_acc_tot();" placeholder="0" value="<?php echo $mtr_acc_cde; ?>" required autofocus></input>
             </td>
             <td></td>
             <td></td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="acc_risc" name = "acc_risc" onchange="calc_acc_tot();" placeholder="0" value="<?php echo $mtr_acc_risc; ?>"></input>
             </td>
             <td></td>
             <td></td>
             <td>Campo opzionale.</td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="acc_nor_trib" name = "acc_nor_trib" onchange="calc_acc_tot();" placeholder="0" value="<?php echo $mtr_acc_nor_trib; ?>"></input>
             </td>
             <td></td>
             <td></td>
             <td>Campo opzionale.</td>
           ...
           <tr style="border-bottom: 1px solid black;">
             ...
             <td>
               <input type="number" min="0" class="campo" id="acc_tot" name = "acc_tot" placeholder="0" value="0" disabled></input>
             </td>
             <td></td>
             <td></td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="miur_eff" name = "miur_eff" onchange="calc_det_tot();" placeholder="0" value="<?php echo $mtr_miur_eff; ?>" required autofocus></input>
             </td>
             <td></td>
             <td></td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="rec_eva_eff" name = "rec_eva_eff" onchange="calc_det_tot();" placeholder="0" value="<?php echo $mtr_rec_eva_eff; ?>"></input>
             </td>
             <td></td>
             <td></td>
             <td>Campo opzionale.</td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="proc_sanz" name = "proc_sanz" onchange="calc_det_tot();" placeholder="0" value="<?php echo $mtr_proc_sanz; ?>"></input>
             </td>
             <td></td>
             <td></td>
             <td>Campo opzionale.</td>
             ...
             <td>
               <input type="number" min="0" class="campo" id="part_ent_comp" name = "part_ent_comp" onchange="calc_det_tot();" placeholder="0" value="<?php echo $mtr_part_ent_comp; ?>"></input>
             </td>
             <td></td>
             <td></td>
             <td>Campo opzionale.</td>
           ...
           <tr style="border-bottom: 1px solid black;">
             ...
             <td>
               <input type="number" min="0" class="campo" id="det_tot" name = "det_tot" placeholder="0" value="0" disabled></input>
             </td>
             <td></td>
             <td></td>
           ...
           <tr>
             ...
             <td>
               <input type="number" min="0" class="campo" id="att_fp" name = "att_fp" onchange="calcola_iva(this, 0.1);" placeholder="0" value="<?php echo $mtr_att_fp; ?>"></input>
             </td>
             <td style="text-align:center">
             ...
             <td>
               <input type="number" min="0" step="0.01" class="campo" id="att_fp_iva" name = "att_fp_iva" placeholder="0" value="<?php echo $mtr_att_fp_iva; ?>"></input>
             </td>
      ...
      <input id="save_mtr" name="save_mtr" class="send" style="width: 100%; color: <?php   if($mtr_canone >= 100000 && strlen($mtr_canone_ben)>0 && $mtr_cts_ben>1 && $mtr_ctr_ben>1 && $mtr_csl_ben>1) {echo 'green';}else{echo 'red';} ?>" type="submit" value="Salva MTR-<?php echo $year ?>" <?php   if($mtr_canone >= 100000 && strlen($mtr_canone_ben)>0 && $mtr_cts_ben>1 && $mtr_ctr_ben>1 && $mtr_csl_ben>1) {echo '';}else{echo 'disabled="true"';} ?>>
       </form>
